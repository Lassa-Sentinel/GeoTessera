...
Before diving into downloads, let's demonstrate how GeoTessera's coordinate system works.
These examples run without network access.
...
```{r tile-grid-viz, fig.width=6, fig.height=5}
library(ggplot2)
...
```{r simulated-embedding-viz, fig.width=7, fig.height=6}
...
```{r embedding-distribution, fig.width=6, fig.height=4}
...
```{r terra-integration, eval=FALSE}
library(terra)
